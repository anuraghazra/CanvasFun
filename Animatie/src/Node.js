function Node(parent, offset, inherit, timelineWidth) {
  this.offset = offset;
  ...
  let top = '';
  if (this.inherit === 'left') top = '10px';
  if (this.inherit === 'top') top = '50px';
  if (this.inherit === 'borderRadius') top = '100px';
  if (this.inherit === 'transform') top = '135px';
...
function Nodes(data, parent, timeline) {
  this.data = data;
  this.parent = parent;
  this.timeline = timeline;
}
Nodes.prototype.render = function(props) {
